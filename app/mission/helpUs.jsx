...
export default function HelpUs() {
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 w-full min-h-[50vh] md:min-h-[60vh]">
      {/* LEFT SIDE */}
      <div className="bg-[#f1ece9] flex flex-col justify-center items-center text-center px-6 py-12 md:py-0">
        ...
        <p
          className={`${nunito.className} text-[#4b4b4b] mt-4 max-w-lg text-base md:text-lg leading-relaxed`}
        >
